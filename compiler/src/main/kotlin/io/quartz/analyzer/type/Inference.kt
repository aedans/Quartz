...
fun ExprT.infer(env: Env): Infer = when (this) {
    ...
    is ExprT.Cast -> monadErrorE().binding {
    ...
    is ExprT.Apply -> monadErrorE().binding {
    ...
    is ExprT.Lambda -> monadErrorE().binding {
    ...
    is ExprT.If -> monadErrorE().binding {
    ...
    is ExprT.Dot -> monadErrorE().binding {
        val (s1, exprType) = expr.infer(env).bind()
