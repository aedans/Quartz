...
class UnableToUnify(t1: TypeK, t2: TypeK) : CompilerError("Unable to unify ${t1 to t2}")
class InfiniteBind(tVar: TypeK.Var, type: TypeK) : CompilerError("Infinite type ${tVar to type}")
